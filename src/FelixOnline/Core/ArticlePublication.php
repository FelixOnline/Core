...
/**
 * Publication history of articles. An article may be published multiple times, for example if there is a major update to a story.
 *
 * Fields:
 * - article: (ForeignKey) ID number of article.
 * - publication_date: (DateTimeField) Date and time for this publication event.
 * - published_by: (ForeignKey) User name of individual who published the article (this will likely be different to the author).
 * - republished: (BooleanField) Flag whether the article has already been published before, and so an "Updated" flag should be shown.

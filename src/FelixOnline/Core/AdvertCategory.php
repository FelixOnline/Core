...
/**
 * Table to allocate adverts to article categories (so adverts may be tailored to individual parts of the website).
 *
 * Fields:
 * - advert: (ForeignKey) ID number of advert.
 * - category: (ForeignKey) ID number of category.
